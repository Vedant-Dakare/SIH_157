    ...
    <div>
      ...
      <div className="mb-6">
        {verifyQuery.isLoading ? (
          ...
          <VerifyResult
            ...
            onExportBroken={() =>
              toast({
                title: 'Chain exported',
                description: 'Broken-chain bundle downloaded.',
              })
            }
          />
        )}
      ...
      <Tabs defaultValue="manifest">
        <TabsList
          ...
          className="border border-[#BFDBFE] bg-[#EFF6FF] p-1"
        >
          <TabsTrigger
            value="manifest"
            className="text-[#123D73] data-[state=active]:bg-[#123D73] data-[state=active]:text-white"
          >
            Run Manifest
          </TabsTrigger>
